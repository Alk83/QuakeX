...
public class Ability {
	...
	/**
	 * Attempt to use this ability. The player must have at least once charge for this operation to be successful. The
	 * player's charge count will be decremented by the given amount.
	 * <p/>
