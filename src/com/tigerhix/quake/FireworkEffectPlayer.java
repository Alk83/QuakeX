 ...
 * <p/>
 * FireworkEffectPlayer provides a thread-safe and (reasonably) version independant way to instantly explode a
 * FireworkEffect at a given location. You are welcome to use, redistribute, modify and destroy your own copies of this
 * source with the following conditions:
 * <p/>
 * 1. No warranty is given or implied. 2. All damage is your own responsibility. 3. You provide credit publicly to the
 * original source should you release the plugin.
 *
 * @author codename_B
 */
